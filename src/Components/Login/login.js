              ...
              <div className={"my-3"}>
                ...
                <BoxShadow>
                  ...
                  <div className={"mx-5 mt-4"}>
                    ...
                    <Input className={"input__bg__login width__345 my-2"} id={tr.mobile} placeholder={tr.enter_mobile}
                           type="number"
              ...
              <div className={"my-3"}>
                ...
                <BoxShadow>
                  ...
                  <div className={"mx-5 mt-4"}>
                    ...
                    <Input className={"input__bg__login width__345 my-2"} id={tr.name} placeholder={tr.enter_name}
                           type="text"
                  ...
                  <div className={"mx-5 mt-4"}>
                    ...
                    <Input className={"input__bg__login width__345 my-2"} id={tr.family} placeholder={tr.enter_family}
                           type="text"
