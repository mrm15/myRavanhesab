...
const Login = (props) => {
  ...
  const submitRegisterForm = () => {
    ...
    //
    if (
      registerFormData.phone_number.length !== 11 ||
      registerFormData.phone_number[0] !== "0"
    ) {
    ...
    axios
      .post("sendRegisterCode/", registerFormData)
  ...
  const submitLoginForm = () => {
    ...
    axios
      .post("sendLoginCode/", { phone_number })
      .then((r) => {
        if (r.data.status) {
          setStatus("loginForm");
          setShowRegisterFormSection(false);
        ...
        <>
          {showLoginFromSection && (
            <>
              <div
                className={
                  "d-flex justify-content-around align-content-center margin_top_5"
                }
              >
                <div className={"margin_top_4 d-none d-md-block"}>
                  <div className="">
                    <img
                      src={computer__icon}
                      alt={tr.welcome_to_my_ravanhesab}
                    />
                  </div>
                </div>
                <div className={"my-3"}>
                  ...
                  <BoxShadow>
                    ...
                    <div className={"mx-5 mt-4"}>
                      <label
                        htmlFor={tr.mobile}
                        className={"d-block  text-end  my-1"}
                      >
                        {tr.mobile}
                      </label>
                      <Input
                        className={"input__bg__login width__345 my-2"}
                        id={tr.mobile}
                        ...
                        onKeyUp={(event) =>
                          event.key === "Enter" && submitLoginForm()
                        }
                      />
                    </div>
              ...
              >
                ...
                <div className={"my-3"}>
                  ...
                  >
                    ...
                    <div>&nbsp;</div>
                    <div className={"mx-5 mt-4"}>
                      <label className={"d-block  text-end  my-1"}>
                        {tr.code_sended_to_numer}{" "}
                        <span className={"green__color fd-font"}>
                      ...
                      >
                        <div
                          className={
                            "d-flex justify-content-around mt-4 width__195 ltr"
                          }
                        >
                          <input
                            id={"1"}
                            onClick={onClickInputCodes}
                            autoFocus={true}
                            onKeyUp={OnKeyUpCode}
                    ...
                    <div className={" text-center"}>
                      <Button
                        id={"buttonToFocusAfterLastDigit"}
